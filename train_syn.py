...
import dataloader_syn as dataload
    ...
    if epoch % 1 == 0:
        ...
        for test_x, test_y in test_dataloader:
            ...
            if args.downstream in ['MLP', 'bprBPR', 'mlpBPR', 'gmfBPR', 'NeuBPR']:
                ...
                test_pa = ut.distcorr(z.cpu().detach().numpy(), test_x[:, :5].cpu().detach().numpy())
                test_nd = ut.distcorr(z.cpu().detach().numpy(), test_x[:, 5:10].cpu().detach().numpy())
                test_dc = ut.distcorr(z.cpu().detach().numpy(), test_x[:, 10:].cpu().detach().numpy())
        ...
        print("Epoch:{}\n test_auc:{}, test_acc:{}, test_pa:{}, test_nd:{}, test_dc:{}, test_adv_auc:{}, test_adv_acc:{}".format(epoch, float(
